...
![Class Diagram](uml_class_diagram.drawio.png)
...
![Sequence Diagram](uml_sequence_diagram.drawio.png)
...
![Activity Diagram](aktivite_diagram.drawio.png)
...
![ER Diagram](varlık_ilişki_diagram.drawio.png)
...
Sistemin merkezde olduğu; Kullanıcı, OpenAI ve OpenWeather arasındaki veri giriş-çıkışlarını kuş bakışı gösteren bağlam diyagramıdır.
 ...
 ![DFD](veri_akış_diagram.drawio.png)
