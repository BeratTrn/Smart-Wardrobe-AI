                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _SectionHeader(title: 'Bugün Ne Giysem?', action: 'Tümünü gör'),
                          const SizedBox(height: 4),
                          Text('$_weatherTemp $_weatherDesc için AI önerileri',
                          ...
                          : _recommendations.isEmpty
                              ...
                              : ListView.builder(
                                  ...
                                  itemBuilder: (_, i) => Padding(
                                    ...
                                    child: _RecommendationCard(item: _recommendations[i]),
                                  ),
                                ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: _SectionHeader(
                        ...
                        onAction: () => Navigator.pushReplacement(
                            context, slide(const WardrobeScreen())),
                      ),
                    ),
                  ),
                  _loading
...
Color _categoryColor(String cat) {
  switch (cat.toLowerCase()) {
    case 'üstler': case 'üst': case 'tops': return AppColors.catTops;
    case 'altlar': case 'alt': case 'bottoms': return AppColors.catBottoms;
    case 'ayakkabı': case 'shoes': return AppColors.catShoes;
    case 'aksesuar': case 'accessory': return AppColors.catAccessory;
    case 'elbiseler': case 'elbise': return AppColors.catOnePiece;
    case 'dış giyim': case 'outerwear': return AppColors.catOuterwear;
...
class _TopBar extends StatelessWidget {
  ...
  const _TopBar({
    required this.userName, required this.weatherTemp,
    required this.weatherDesc, required this.weatherIcon,
  });
    ...
    return Row(children: [
      Expanded(
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text('Merhaba,', style: AppTextStyles.label.copyWith(letterSpacing: 1)),
          const SizedBox(height: 2),
          Text(userName, style: const TextStyle(
            fontFamily: 'Cormorant', fontSize: 28,
            fontWeight: FontWeight.w700, color: AppColors.text, letterSpacing: -.5,
          )),
        ]),
      ),
      Container(
      ...
      Container(
        ...
        child: const Icon(Icons.person_rounded, color: Colors.black, size: 20),
      ),
    ]);
  }
}
...
class _AiBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Row(mainAxisSize: MainAxisSize.min, children: [
          const Icon(Icons.auto_awesome_rounded, color: AppColors.goldLight, size: 13),
          const SizedBox(width: 5),
          Text('AI ÖNERİSİ',
              style: AppTextStyles.label.copyWith(
                  color: AppColors.goldLight, letterSpacing: 1.4, fontSize: 10)),
        ]),
      );
}
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          child: ClipRRect(
            ...
            child: item.imageUrl != null
                ? Image.network(item.imageUrl!, fit: BoxFit.cover, width: double.infinity,
                    errorBuilder: (_, __, ___) => _ImgPlaceholder(color: accent))
        ...
        Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text(item.category, style: TextStyle(color: accent, fontSize: 11)),
          ]),
        ),
      ]),
    );
          ...
          return Container(
            ...
            child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
              Container(
                width: 40, height: 40,
                decoration: BoxDecoration(
                    color: c.$3.withOpacity(.12), shape: BoxShape.circle),
...
class _EmptyWardrobe extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: const Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          SizedBox(height: 4),
          Text('+ butonuna bas, dolabını oluştur',
...
class _ShimmerGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Padding(
        ...
        child: GridView.builder(
          ...
          itemCount: 4,
          gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
            crossAxisCount: 2, mainAxisSpacing: 14, crossAxisSpacing: 14, childAspectRatio: .75,
          ),
          itemBuilder: (_, __) => Container(
            decoration: BoxDecoration(
              color: AppColors.surface,
